...
function isSolePathSupportOpen()
{
    return true;
//    $phoneIsOpen = true;
//    $todayDT = new DateTime("America/Edmonton");
//
//    $weekday = $todayDT->format('N'); // 6=Sat, 7=Sun
//    $h = $todayDT->format('G');
//
//    //error_log("Weekday: $weekday and hour is $h");
//
//    // check M-F, 5:00am to 5:00pm
//    if ($weekday > 5 || $h < 9 || $h > 18) {
//        $phoneIsOpen = false;
//    }
//
//    return $phoneIsOpen;
...
function isSolePathSupportOpenTest()
{
    $phoneIsOpen = true;
    $todayDT = new DateTime("America/Edmonton");
    ...
    echo "<br />" . $todayDT->format("D M j G:i:s T Y") . "<br />";
    echo "<br /> WD: " . $weekday. "<br />";
    echo "<br /> H: " . $h. "<br />";

    // check M-F, 5:00am to 5:00pm
    if ($weekday > 5 || $h < 9 || $h >= 18) {
        $phoneIsOpen = false;
    } // else, check to see if it's a holiday
